...
Use this procedure/method to get a list of the supported ields for utopian
postcodes.
...
Specify a field and a value on the command line, e.g.
"C<multiselection_u2 xxxxxxxxxxxxxx>". 
...
This tutorial is free; you can redistribute it and/or modify it under
