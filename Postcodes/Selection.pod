...
This file uses the fictious country I<Utopia> (with country code 'U2'),
...
It is possible, even adviceable, to use external procedures in the argumnet
...
for use by the selection procedure/method.
